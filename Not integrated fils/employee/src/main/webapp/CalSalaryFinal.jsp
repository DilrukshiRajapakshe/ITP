                ...
                <div class="col-sm-10  ha-co1 ">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" name="salary"  id="input2" value="<%=list.get(3)%>" pattern="{1,50}" >
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Year</span>
                          </div>
                          <input type="text" class="form-control" name="year" placeholder="Enter Currant Year " id="input2" pattern="{1,20}" title="Enter Integer value" value="<%=list.get(4)%>">
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Month</span>
                          </div>
                          <input type="text" class="form-control" name="month" placeholder="Enter Currunt Month " id="input2" pattern="{1,20}" title="Enter Integer value" value="<%=list.get(5)%>">
                        </div>
                         <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Allowance</span>
                          </div>
                          <input type="text" class="form-control" name="allowance" placeholder="Enter Allowance" id="input2" pattern="[0-9]{1,20}" title="Enter Integer value" value="<%=list.get(6)%>">
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Bonus</span>
                          </div>
                          <input type="text" class="form-control" name="bonus" placeholder="Enter Bonus " id="input2" pattern="[0-9]{1,20}" title="Enter Integer value" value="<%=list.get(7)%>">
                        </div>
                         <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Loans</span>
                          </div>
                          <input type="text" class="form-control" name="loans" placeholder="Enter Loans " id="input2" pattern="{1,20}" title="Enter Integer value" value="<%=list.get(8)%>">
                        </div>
                                <br>
                                ...
                                <br>
								 ...
								 <div class="input-group mb-3">
                                  ...
                                  <input type="text" class="form-control"  id="input2" name="days" value="<%=list.get(9)%>">
                                </div>
                                </div>
								 <div class="input-group mb-3">
                                  <div class="input-group-prepend">
                                  ...
                                  <input type="text" class="form-control"  id="input2" name="monthlysalary" value="<%=list.get(10)%>">
                                </div>
								<div class="th">
								 </div>
                                <button type="submit" class="btn btn-outline-secondary" id="createbutton"name ="st" value="confirm2">Confirm</button>
