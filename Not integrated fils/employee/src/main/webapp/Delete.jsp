...
<div class="contaianer">
        ...
        <div class="row my-row6">
                <div class="col-sm-2  my-col2 ">
					   ...
					   <div class="row"><a href="addSupplier.html" target="_self" class="link1"><i class="fas fa-dolly-flatbed"></i></i>&ensp;Supplire</a></div>
                </div>
                <div class="col-sm-10  my-col3 ">
                    ...
                    <form style="text-align:center"action="delete" method="post">
						...
						<div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" name="occupation" placeholder="Enter Remove Supplier Items" id="input2" value="<%=list.get(4)%>">
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Salary</span>
                          </div>
                          <input type="text" class="form-control" name="salary" placeholder="Enter Remove Supplier Items" id="input2" value="<%=list.get(5)%>">
                        </div>
						<div class="input-group mb-3">
                          <div class="input-group-prepend">
