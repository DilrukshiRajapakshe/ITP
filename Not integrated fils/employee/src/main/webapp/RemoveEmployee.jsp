                        ...
                        %>
	                        <form action="removeEmployee" method="post">
								<tr>
								  ...
								  <td><input type="hidden" name="email" value="<%=list.get(4)%>"><%=list.get(4) %></td>
								  <td><input type="hidden" name="contact" value="<%=list.get(5)%>"><%=list.get(5) %></td>
								  <td><input type="hidden" name="rdate" value="<%=list.get(6)%>"><%=list.get(6) %></td>
								  <td><input type="hidden" name="Rreasone" value="<%=list.get(7)%>"><%=list.get(7) %></td>
