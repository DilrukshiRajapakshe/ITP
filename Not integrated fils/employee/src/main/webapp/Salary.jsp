        ...
        <div class="row my-row6">
                ...
                <div class="col-sm-10  my-col3 ">
                        <br>
                            ...
                            <br>
                    <h1 style="text-align: center">Employee Salary</h1>
                    ...
                    <br>
					  ...
					  <%
                        ...
                        %>
	                        <form action="salarycal" method="post">
								<tr>
								  ...
								  <td><input type="hidden" name="occupation" value="<%=list.get(2)%>"><%=list.get(2) %></td>
								  <td><input type="hidden" name="salary" value="<%=list.get(3)%>"><%=list.get(3) %></td>
								  <td><button type="Update" class="btn btn-btncolorPaple" id="createbutton" name="st" Value="calculate">Calculate Salary</button>
								  	<input type="hidden" name="Id" value="<%=list.get(0)%>">
								  </td>
								  <td><button type="Delete" class="btn btn-btncolorbrown" id="createbutton" name="st" Value="viewSalary">View Salary Details</button>
								  	<input type="hidden" name="Id" value="<%=list.get(0)%>">
								  </td>
								</tr>
							</form>
