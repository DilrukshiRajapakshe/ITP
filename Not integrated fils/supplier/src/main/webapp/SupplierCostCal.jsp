        ...
        <div class="row my-row6">
                ...
                <div class="col-sm-10  ha-co1 ">
                    ...
                    <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" name="orderid" placeholder="Enter Order ID" id="input2" pattern="[0-9]{1,3}" title="Three order id">
                        </div>
                         <div class="input-group mb-3">
                          <div class="input-group-prepend">
						...
						<div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control" name="name" placeholder="Enter Supplier Name" id="input2" value="<%=list.get(1)%>" pattern="[A-Za-z]{1,50}" title="Enter supplier name">
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Items</span>
                          </div>
                          <input type="text" class="form-control" name="item" placeholder="Enter Items" id="input2" value="<%=list.get(2)%>" pattern="[A-Za-z]{1,50}" title="Enter item name">
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Date</span>
                          </div>
                          <input type="text" class="form-control" name="date" placeholder="Enter Currant Date " id="input2" pattern="{1,20}" title="Enter Currunt Date">
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Warranty Period </span>
                          </div>
                          <input type="text" class="form-control" name="warranty" placeholder="Enter Warranty Period " id="input2" pattern="{1,20}" title="Enter Warranty Period">
                        </div>
                         <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Item Price</span>
                          </div>
                          <input type="text" class="form-control" name="itemprice" placeholder="Enter Item Price" id="input2" pattern="[0-9]{1,20}" title="Enter Item Price">
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Quantity</span>
                          </div>
                          <input type="text" class="form-control" name="quantity" placeholder="Enter Quantity " id="input2" pattern="[0-9]{1,20}" title="Enter Quantity">
                        </div>
                         <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Discount (%)</span>
                          </div>
                          <input type="text" class="form-control" name="discount" placeholder="Enter Discount " id="input2" pattern="{1,20}" title="Enter Discount">
                        </div>
                                <br>
                                <button type="submit" class="btn btn-outline-secondary" id="createbutton" name ="st" value="calculatedd">Calculate</button>
                                <br>
                                </form>
								 <div class="input-group mb-3">
                                  <div class="input-group-prepend">
                                  ...
                                  <input type="text" class="form-control" placeholder="Final Amount " id="input2" name="final">
                                </div>
                                </div>
								 <div class="input-group mb-3">
                                  <div class="input-group-prepend">
                                  ...
                                  <input type="text" class="form-control" placeholder="Final Item Amount " id="input2" name="finalItem">
                                </div>
								<div class="th">
								 </div>
								 <form style="text-align:center">
                                <button type="submit" class="btn btn-outline-secondary" id="createbutton"name ="st" value="update">Confirm</button>
                              </form>
                            </td>
                            </tr>
                            </table>
