        ...
        <div class="row my-row6">
                <div class="col-sm-2  my-col2 ">
                       ...
                       <div class="row"><a href="default.asp" target="_blank" class="link1"><i class="fas fa-edit"></i>&ensp;Activity</a></div>
					    <div class="row"><a href="default.asp" target="_self" class="link2"><i class="fas fa-dolly-flatbed"></i></i>&ensp;Supplire</a></div>
                </div>
                <div class="col-sm-10  ha-co1 ">
                        <br>
                    <h1 style="text-align: center">Calculate Supplier Cost</h1>
                    <%
						  int Total = 0;
	                      int count = 0;
                    ...
                    <table class="table">
                        <tr>
                            <td>
                    <form style="text-align:center"action="calculate" method="post">
                    <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Order ID</span>
                          </div>
                          <input type="text" class="form-control" name="orderid" placeholder="Enter Order ID" id="input2" pattern="[0-9]{1,3}" title="Three order id"value="<%=list.get(0)%>">
                        </div>
                         <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Supplier ID</span>
                          </div>
                          <input type="text" class="form-control" name="id" placeholder="Enter New Supplier ID" id="input2" value="<%=list.get(1)%>" pattern="[0-9]{1,3}" title="Three number supplier id">
                        </div>
						<div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Full Name</span>
                          </div>
                          <input type="text" class="form-control" name="name" placeholder="Enter Supplier Name" id="input2" value="<%=list.get(2)%>" pattern="[A-Za-z]{1,50}" title="Enter supplier name">
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Items</span>
                          </div>
                          <input type="text" class="form-control" name="item" placeholder="Enter Items" id="input2" value="<%=list.get(3)%>" pattern="[A-Za-z]{1,50}" title="Enter item name">
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Date</span>
                          </div>
                          <input type="text" class="form-control" name="date" placeholder="Enter Currant Date " id="input2" pattern="{1,20}" title="Enter Currunt Date"value="<%=list.get(4)%>">
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Warranty Period </span>
                          </div>
                          <input type="text" class="form-control" name="warranty" placeholder="Enter Warranty Period " id="input2" pattern="{1,20}" title="Enter Warranty Period"value="<%=list.get(5)%>">
                        </div>
                         <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Item Price</span>
                          </div>
                          <input type="text" class="form-control" name="itemprice" placeholder="Enter Item Price" id="input2" pattern="[0-9]{1,20}" title="Enter Item Price"value="<%=list.get(6)%>">
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Quantity</span>
                          </div>
                          <input type="text" class="form-control" name="quantity" placeholder="Enter Quantity " id="input2" pattern="[0-9]{1,20}" title="Enter Quantity"value="<%=list.get(7)%>">
                        </div>
                         <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Discount (%)</span>
                          </div>
                          <input type="text" class="form-control" name="discount" placeholder="Enter Discount " id="input2" pattern="{1,20}" title="Enter Discount"value="<%=list.get(8)%>">
                        </div>
                                <br>
                                <button type="submit" class="btn btn-outline-secondary" id="createbutton" name ="st" value="calculateadd">Calculate</button>
                                <br>
                                
								 <div class="input-group mb-3">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text" id="input1">Final Total Amount </span>
                                  </div>
                                  <input type="text" class="form-control" placeholder="Final Amount " id="input2" name="final"value="<%=list.get(9)%>">
                                </div>
								 <div class="input-group mb-3">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text" id="input1">Final Item Amount </span>
                                  </div>
                                  <input type="text" class="form-control" placeholder="Final Item Amount " id="input2" name="finalItem"value="<%=list.get(10)%>">
                                </div>
								<div class="th">
								 </div>
                                <button type="submit" class="btn btn-outline-secondary" id="createbutton"name ="st" value="confirm">Confirm</button>
                              </form>
                            </td>
                            </tr>
                            </table>
