                        ...
                        %>
	                        <form action="readSupplier" method="post">
								<tr>
								  ...
								  <td><button type="Update" class="btn btn-btncolorPaple" id="createbutton" name="st" Value="Order">Order</button>
								  	<input type="hidden" name="Id" value="<%=list.get(0)%>">
								  </td>
								  <td><button type="Update" class="btn btn-btncolorPaple" id="createbutton" name="st" Value="Orderview">View Orders</button>
								  	<input type="hidden" name="Id" value="<%=list.get(0)%>">
								  </td>
								</tr>
							</form>
