        ...
        <div class="row my-row6">
                ...
                <br>
						...
						<tr>
						  ...
						  <th scope="col">Final Item Cost</th>
					  ...
					  <%
                        ...
                        %>
	                        <form action="readSupplier" method="post">
								<tr>
								  ...
								  <td><input type="hidden" name="email" value="<%=list.get(3)%>"><%=list.get(3) %></td>
								  <td><input type="hidden" name="address" value="<%=list.get(4)%>"><%=list.get(4) %></td>
								  <td><input type="hidden" name="contact" value="<%=list.get(5)%>"><%=list.get(5) %></td>
								  <td><input type="hidden" name="item" value="<%=list.get(6)%>"><%=list.get(6) %></td>
								  <td><input type="hidden" name="item" value="<%=list.get(7)%>"><%=list.get(7) %></td>
								  <td><input type="hidden" name="item" value="<%=list.get(8)%>"><%=list.get(8) %></td>
								  <td><input type="hidden" name="item" value="<%=list.get(9)%>"><%=list.get(9) %></td>
								  <td><input type="hidden" name="item" value="<%=list.get(10)%>"><%=list.get(10) %></td>
