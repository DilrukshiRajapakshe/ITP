...
<div class="contaianer">
        ...
        <div class="row my-row6">
                ...
                <div class="col-sm-10  my-col3 ">
                        <br>
                    <h1 style="text-align: center">SUPPLIER MANAGEMENT</h1>
					<br>
                    <form align="center" action="supplier"  method="post">
					      <button type="add" class="btn btn-info btn-block" name="st" Value="addsup">ADD SUPPLIER</button>
						  <br>
						  <button type="noti" class="btn btn-info btn-block" name="st" Value="noti">NOTIFICATION</button>
						  <br>
						  <button type="reports" class="btn btn-info btn-block" name="st" Value="reports">REPORTS</button>
						  <br>
						  <button type="cost" class="btn btn-info btn-block" name="st" Value="cost">SPPLIER COST</button>
						  <br>
						  <button type="supplier" class="btn btn-info btn-block" name="st" Value="supplier">SUPPLIER</button>
						  <br>
						  <button type="removesupplier" class="btn btn-info btn-block" name="st" Value="removesupplier">REMOVE SUPPLIER</button>
						 </form>
                </div>
