...
public class search3Service {
	...
	public ArrayList searchReport(search3 search) throws SQLException {
		...
		String query1 = "select * from report where year like '%"+year+"%' and month like '%"+month+"%' and day like '%"+day+"%'";
