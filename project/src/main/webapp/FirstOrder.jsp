        ...
        <div class="row my-row6">
                ...
                <div class="col-sm-10  my-col3 ">
                    ...
                    <form align="center" action="order"  method="post">
					      <button type="submit" class="btn btn-info btn-block" name="st" value="addget">GET ORDER</button>
						  <br>
						  <button type="view" class="btn btn-info btn-block" name="st" value="view">VIEW ORDER</button>
						  <br>
						  <button type="reports" class="btn btn-info btn-block" name="st" value="reports">REPORT</button>
				  </form>
                </div>
