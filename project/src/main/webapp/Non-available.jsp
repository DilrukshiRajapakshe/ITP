...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <title>View Non-Available Item Information</title>
    ...
    <div class="contaianer">
        ...
        <div class="row my-row6">
                ...
                <div class="col-sm-10  my-col3 ">
                        <br>
                    <h1 style="text-align: center">View Non-Available Item Information</h1>
                    <br>
	                        ...
	                        <form action="readTable" method="post">
								<tr>
								  ...
								  <td><button type="Update" class="btn btn-btncolorPaple" id="createbutton" name="st" Value="Update">Update</button>
								  	...
								  	<input type="hidden" name="amount" value="<%=list.get(6)%>">
								  </td>
								  <td><button type="Delete" class="btn btn-btncolorbrown" id="createbutton" name="st" Value="NonDelete">Deleted</button>
								  	<input type="hidden" name="Id" value="<%=list.get(0)%>">
								  	<input type="hidden" name="type" value="<%=list.get(7)%>">
								  	<input type="hidden" name="amount" value="<%=list.get(6)%>">
								  </td>
					...
					<form align="center" action="nonAvailable" method="post">
						<button type="submit" class="btn" id="createbutton" name="st" Value="Add">Add</button>
						<button type="submit" class="btn" id="createbutton" name="st" Value="Damage">Damage</button>
