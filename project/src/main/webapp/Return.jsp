...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <title>View Return Item Information</title>
 ...
 <div class="contaianer">
        ...
        <div class="row my-row6">
                ...
                <div class="col-sm-10  my-col3 ">
                        <br>
                    <h1 style="text-align: center">View Return Item Information</h1>
                    <br>
                    <table class="table table-striped">
					  ...
					  <%
						...
						<form action="Viewreturn" method="post" align="center">
							...
							<button type="submit" class="btn" id="createbutton" name="st" value="Reparing">Repaired</button>
							<button type="submit" class="btn" id="createbutton" name="st" value="Non-Reparing">Non-Repaired</button>
							<button type="submit" class="btn" id="createbutton" name="st" value="All-view">All View</button>
