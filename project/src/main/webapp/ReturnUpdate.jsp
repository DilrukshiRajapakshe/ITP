...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <script language ="javascript" type="text/javascript" src ="resources/Validation/MyForm.js"></script>
        ...
        <div class="row my-row6">
                ...
                <div class="col-sm-10  card border-info ">
	                 	...
	                 	<tr>
	                    	...
	                    	<th >
		                    	<form action="ReturnInsert" method="post">
									...
									<input type="hidden"  name="cuName" value="nimal" >
                    ...
                    <table class="table">
                        <tr>
                            <td>
								<form style="text-align:center" action="ReturnInsert" method="post" >
									<div class="input-group mb-3">
									  <div class="input-group-prepend">
										<span class="input-group-text" id="input1" value="a"  >Name</span>
									  </div>
									  <input type="text" class="form-control"  id="input2"name="name" value="<%=list.get(0)%>">
									</div>
									...
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control" id="input2"name="Id" value="<%=list.get(1)%>">
									</div>
									...
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control" id="input2"name="supplierID" value="<%=list.get(2)%>">
									</div>
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text"  id="input1" value="d">Customer Name</span>
										</div>
										<input type="text" class="form-control" id="input2"name="cuName" value="<%=list.get(3)%>">
									</div>
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text"  id="input1" value="d">Customer Telephone No</span>
										</div>
										<input type="text" class="form-control" id="input2"name="telNo" value="<%=list.get(4)%>">
									</div>
									<div class="input-group mb-3">
										<div class="input-group-prepend">
									...
									<div class="input-group mb-3">
										...
										<div>
										      <input id="input-datetime-local"  class="form-control" value="<%=list.get(7)%>" id="input3"name="date">
										</div>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<div class="input-group-prepend">
										...
										<div>
										      <input id="input-datetime-local" class="form-control" value="<%=list.get(8)%>" id="input3"name="today">
										</div>
									</div>
									<div class="input-group mb-3">
									    <div class="input-group-prepend">
									    ...
									    <select class="form-control" id="sel1"name="type" >
									    	<option value="<%=list.get(8)%>"><%=list.get(9)%></option> 
									    	<option value="Reparing-item">Return item</option>
											<option value="Return-item">Return item</option>
											<option value="NonReparing-item">NonReparing item</option>
										</select>
									</div>	
									<button type="submit" class="btn" id="createbutton" name ="st" Value="Update" >Insert</button>
								</form>
                    ...
                    <form align="center" action="ViewAction" method="post">
                    	<button type="View" class="btn" id="createbutton" name="st" Value="View">View</button>
