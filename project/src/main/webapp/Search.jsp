        ...
        <div class="row my-row6">
				...
				<br>	
                    <table>
	                 <thead>
	                 	<tr>
	                    	<th><h1 style="margin-right: 450px">Stock item Search</h1></th>
	                    	<th >
		                    	<form action="search" method="post">
		                    		<input type="hidden"  name="name" value="kumari" >
									<input type="hidden"  name="type" value="Return-item" >
								
		                    		<button type="submit" class="btn" id="createbutton" name ="st" value="Search">Insert</button>
		                    	</form>
	                    	</th>
	                    </tr>
	                  </thead>
                        ...
                        <tr>
                            <td>
								<form style="text-align:center" action="search"  method="post">
									...
									<div class="input-group mb-3">
									    <div class="input-group-prepend">
											<span class="input-group-text"  id="input1" >Type</span>
										</div>
									...
									<button type="Reset" class="btn" id="createbutton" name="Reset">Reset</button>
									<button type="Search" class="btn" id="createbutton" name="Search">Search</button>
								</form>
