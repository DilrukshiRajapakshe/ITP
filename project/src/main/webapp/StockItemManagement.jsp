...
<div class="contaianer">
        ...
        <div class="row my-row6">
				...
				<br>
					<h1 align="center">Select the Link</h1>
				<br>	
				<form action="mainPage" method="post">
					<ul class="list-group list-group-flush">
					
					  <button type="submit" class="btn btn-primary btn-block" name="st" Value="stockI" >Stock Item Insert</button>
					  <button type="submit" class="btn btn-primary btn-block" name="st" Value="damageI">Damage Item Insert</button>
					  <button type="submit" class="btn btn-primary btn-block" name="st" Value="returnI">Return Item Insert</button>
					  <button type="submit" class="btn btn-primary btn-block" name="st" Value="repairedI">Repaired Item Insert</button>
					  <button type="submit" class="btn btn-primary btn-block" name="st" Value="nonRepired">Non Available Item</button>
					  <button type="submit" class="btn btn-primary btn-block" name="st" Value="damage">Damage Item</button>
					  <button type="submit" class="btn btn-primary btn-block" name="st" Value="stock">Stock Item</button>
					  <button type="submit" class="btn btn-primary btn-block" name="st" Value="repaired">Repaired Item</button>
					  <button type="submit" class="btn btn-primary btn-block" name="st" Value="nonRepired">Non Repaired Item</button>
					  <button type="submit" class="btn btn-primary btn-block" name="st" Value="return">Return Item</button>
					  <button type="submit" class="btn btn-primary btn-block" name="st" Value="retort">Report</button>
					  <button type="submit" class="btn btn-primary btn-block" name="st" Value="search">Search</button>
					</ul>
				</form>
					<br>
                </div> 
