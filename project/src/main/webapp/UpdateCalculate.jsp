        ...
        <div class="row my-row6">
                ...
                <div class="col-sm-10  my-col3 ">
                    ...
                    <table class="table">
                        <tr>
                            <td>
                    <form style="text-align:center"action="final" method="post">
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Order No</span>
                          </div>
                          <input type="text" class="form-control" placeholder="Enter order no" id="input1" name="no" value="<%=list.get(0)%>">
                        </div>
                            ...
                            <div class="input-group mb-3">
                              ...
                              <input type="text" class="form-control" placeholder="Enter Customer Name" id="input2" name="name" value="<%=list.get(1)%>"pattern="[A-Za-z]{1,50}" title="Enter customer name">
                                ...
                                <br>
                                <button type="submit" class="btn btn-outline-secondary" id="createbutton" name ="st" value="cal">Calculate</button>
                                <br>
                                ...
                                <button type="submit" class="btn btn-outline-secondary" id="createbutton"name ="st" value="sucsess">UPDATE</button>
                              </form>
                            </td>
                            </tr>
                            </table>
