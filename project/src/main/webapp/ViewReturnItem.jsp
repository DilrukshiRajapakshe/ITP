...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <title>View Return and Reparing Item Information</title>
 ...
 <div class="contaianer">
        ...
        <div class="row my-row6">
                ...
                <div class="col-sm-10  my-col3 ">
                        <br>
                    <h1 style="text-align: center">View Return and Reparing Item Information</h1>
                    <br>
                    <table class="table table-striped">
					  ...
					  <%
						...
						<form align="center" action="Viewreturn" method="post" >
							
								<button type="Add" class="btn" id="createbutton" name="st" Value="Add">Add</button>
								<button type="Return" class="btn" id="createbutton" name="st" Value="Return">Return</button>
								<button type="Reparing" class="btn" id="createbutton" name="st" Value="Reparing">Repaired</button>
								<button type="NonReparing" class="btn" id="createbutton" name="st" Value="Non-Reparing">Non-Repaired</button>
