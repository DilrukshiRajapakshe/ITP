                    ...
                    <table class="table">
                        <tr>
                            <td>
                               ...
                               <br>
                             <form name="myForm"  action = "addCost"  method="post">
                            	<input type="hidden" name="cost_type" value="Furniture">
                            	<input type="hidden" name="amount" value="20000">
                            	<button type="submit" class="btn btn-outline-secondary" name="addAll" id="addbutton"  value="add">Demo</button>	
                            </form>   
                           </td>
                           </tr>
                           <tr>
                    ...
                    <form name="myForm"  action = "addCost"  method="post" >
                        <div class="input-group padd1">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="inputtype" value="etype">Expenses Type</span>
                          </div>
                          <input type="text" class="form-control" placeholder="Enter the Expenses Type" id="inputcont" name="cost_type" pattern="[A-Za-z]*[A-Za-z]">
                        </div>
                        &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
                            ...
                            <div class="input-group padd1">
                              <div class="input-group-prepend">
                                <span class="input-group-text"  id="inputtype" value="ecost">Cost</span>
                              </div>
                              <input type="text" class="form-control" placeholder="Enter Amount" id="inputcont"  name="amount" pattern= "[0-9]*[0-9]*[0-9]*[0-9]">
                            </div>
