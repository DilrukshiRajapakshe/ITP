                ...
                <table class="table">
                    <tr>
                        ...
                        <div class="col-sm-12">
                            ...
                            <a href="report1"><button type="Submit" class="btn btn-info">Download PDF</button></a>
                        </div>
                        </td>
                    </tr>
                    <tr>
                                      ...
                                      <tr>
                                        <th scope="row"><%=count %></th>
                							...
                							<td><%=search_list.get(3)%></td>
               	 							<td><%=search_list.get(4)%>/<%=search_list.get(5)%>/<%=search_list.get(6)%></td>
               	 							<td><%=search_list.get(7)%></td>
                                      </tr>
