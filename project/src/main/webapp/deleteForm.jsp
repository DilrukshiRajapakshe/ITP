        ...
        <div class="row my-row6">
                ...
                <div class="col-sm-10  my-col3 ">
                    ...
                    <table class="table">
                        <tr>
                            <td>
                    <form style="text-align:center"action="orderDelete" method="post">
                        <div class="input-group mb-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text" id="input1" >Order No</span>
                          </div>
                          <input type="text" class="form-control" placeholder="Enter order no" id="input1" name="no" value="<%=list.get(0)%>"pattern="[0-9]{1,3}" title="Three number order no">
                        </div>
                              ...
                              <input type="text" class="form-control" placeholder="Enter Customer Name" id="input2" name="name" value="<%=list.get(1)%>"pattern="[A-Za-z]{1,50}" title="Enter customer name">
                                ...
                                <div class="input-group mb-3">
                                  <div class="input-group-prepend">
								   ...
								   <input type="text" class="form-control" placeholder="Enter Address  " id="input2" name="addr" value="<%=list.get(2)%>"pattern="[A-Za-z]{1,50}" title="Enter customer address">
                            </div>
								   <div class="input-group mb-3">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text" id="input1">Contact No</span>
                                  </div>
								   <input type="text" class="form-control" placeholder="Enter Contact No  " id="input2" name="contact" value="<%=list.get(3)%>"pattern="[0-9]{10}" title="Ten number contact no">
                            </div>
								  <div class="input-group mb-3">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text" id="input1">Order Items </span>
                                  </div>
                                  <input type="text" class="form-control" placeholder="Enter Order Items" id="input2" name="items" value="<%=list.get(4)%>"pattern="[A-Za-z]{1,50}" title="Enter customer oeder items">
                                </div>
                                <div class="input-group mb-3">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text" id="input1">Item Quantity</span>
                                  </div>
                                  <input type="text" class="form-control" placeholder="Enter Final Amount " id="input2" name="quantity" value="<%=list.get(5)%>"pattern="[0-9]{1,10}" title="Enter Final amount">
                                </div>
                                 <div class="input-group mb-3">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text" id="input1">Bill No</span>
                                  </div>
                                  <input type="text" class="form-control" placeholder="Enter Final Amount " id="input2" name="billno" value="<%=list.get(6)%>"pattern="[0-9]{1,10}" title="Enter Final amount">
                                </div>
								 <div class="input-group mb-3">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text" id="input1">Item price</span>
                                  </div>
                                  <input type="text" class="form-control" placeholder="Enter Item price" id="input2" name="amount" value="<%=list.get(7)%>"pattern="[0-9]{1,10}" title="Enter amount of order">
                                </div>
								 <div class="input-group mb-3">
                                  <div class="input-group-prepend">
								...
								<div class="th">
						         <p><b> confirm cancel </b></p>
								 </div>
                                <button type="submit" class="btn btn-outline-secondary" id="createbutton"name ="st" value="Cancel">Cancel</button>
								&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
								<button type="submit" class="btn btn-outline-secondary" id="createbutton"name ="st" value="delete">OK</button>
                              </form>
                            </td>
                            </tr>
                            </table>
