        ...
        <div class="row my-row6">
              ...
              <div class="col-sm-10 mc1">
                    ...
                    <tr>
                        ...
                        <td><input type="hidden" name="Id" value="<%=search_list.get(0)%>"><%=search_list.get(0)%></td>
                
                        <td><input type="hidden" name="noteDate" value="<%=search_list.get(1)%>"><%=search_list.get(1)%></td>
                   
                        <td><input type="hidden" name="cost_type" value="<%=search_list.get(2)%>"><%=search_list.get(2)%></td>
                         <td><input type="hidden" name="amount" value="<%=search_list.get(3)%>"><%=search_list.get(3)%></td>
                        
                        <td>
                        							
                									<button type="submit" class="btn btn-danger"  name="del" value="delete">Delete</button>
                							</td>
