        ...
        <div class="row my-row6">
                ...
                <table class="table">
                    <tr>
                        <td>
                        <div class="col-sm-12">
                            <h1 style="text-align:center">Get Report</h1>
                             <a href="report2"><button type="Submit" class="btn btn-info">Download PDF</button></a>
                        </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="col-sm-12">
                                <form action="search3" method="POST" name="form3" onsubmit="return(validationReportSearch());">
                                      ...
                                      <tr>
                                        <th scope="row"><%=count %></th>
                							...
                							<td><input type="hidden" name="password" value="<%=search_list.get(2)%>"><%=search_list.get(2)%></td>
               	 							<td><input type="hidden" name="email" value="<%=search_list.get(3)%>"><%=search_list.get(3)%>/<%=search_list.get(4)%>/<%=search_list.get(5)%></td>
